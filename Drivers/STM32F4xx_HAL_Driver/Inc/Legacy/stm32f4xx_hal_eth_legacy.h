...
#define ETH_DMA_RX_OVERFLOW_MISSEDFRAMES_COUNTERSHIFT 17U
    ...
    typedef struct
    {
        ...
        uint32_t
            BroadcastFramesReception; /*!< Selects or not the reception of Broadcast Frames.
    ...
    typedef struct
    {
        ...
        uint32_t
            TransmitThresholdControl; /*!< Selects or not the Transmit Threshold Control.
        ...
        uint32_t
            ReceiveThresholdControl; /*!< Selects the threshold level of the Receive FIFO.
...
#define ETH_HEADER 14U /*!< 6 byte Dest addr, 6 byte source addr, 2 byte length/type */
